...
import {
   selectAuthBetsBigWins,
   selectAuthCurrencyOption,
   selectAuthCurrentBrand,
   selectAuthOperator,
} from 'redux/authSlice'
import { selectLoadingBigWins } from 'redux/loadingSlice'
import {
...
export default function BigWins({
   ...
   const data = useSelector(selectAuthBetsBigWins)
   ...
   const loadingBigWins = useSelector(selectLoadingBigWins)
