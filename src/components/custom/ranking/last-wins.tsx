...
import {
   selectAuthBetsLatestWins,
   selectAuthCurrencyOption,
   selectAuthCurrentBrand,
   selectAuthOperator,
} from 'redux/authSlice'
import { selectLoadingLatestWins } from 'redux/loadingSlice'
import {
...
export default function LastWinners({
   ...
   const loadingLatestWins = useSelector(selectLoadingLatestWins)
   const currencyOption = useSelector(selectAuthCurrencyOption)
   const data = useSelector(selectAuthBetsLatestWins)
