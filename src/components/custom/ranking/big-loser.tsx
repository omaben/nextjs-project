...
import {
   selectAuthBetsBigLosses,
   selectAuthCurrencyOption,
   selectAuthCurrentBrand,
   selectAuthOperator,
} from 'redux/authSlice'
import { selectLoadingBigLosses } from 'redux/loadingSlice'
import {
...
export default function BigLoser({
   startDate,
   endDate,
   searchDate,
}: StartEndDateProps) {
   ...
   const data = useSelector(selectAuthBetsBigLosses)
   ...
   const loadingBigLosse = useSelector(selectLoadingBigLosses)
