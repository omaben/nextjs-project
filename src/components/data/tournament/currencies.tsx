...
function TournamentCurrencies(dataFilter: {
   data: TournamentCurrencyConditionItem[]
   ...
   const handleSubmitValues = React.useCallback(
      async (dto: {
         packages: TournamentCurrencyConditionItem[]
         index?: number
      }) => {
   ...
   useEffect(() => {
      if (dataFilter.data && currenciesData === 0) {
         setInitialValuesData(dataFilter.data)
...
export default TournamentCurrencies
