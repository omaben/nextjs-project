...
function OperatorReports() {
   ...
   if (query.opId && query.opId !== 'all') {
      postYear.opId = query.opId as string
      postMonths.opId = query.opId as string
      postDays.opId = query.opId as string
      postHours.opId = query.opId as string
   }
   ...
   if (query.opId && query.opId !== 'all') {
      postReportStats.opId = query.opId as string
   }
   if (currentBrandId !== 'All Brands') {
...
OperatorReports.getLayout = function getLayout(page: ReactElement) {
