...
import AllGameCores from '@/components/data/games/game-cores-grid'
...
import { saveGameCoresList, saveGamesList } from 'redux/authSlice'
import { saveLoadingGameCoresList, saveLoadingGamesList } from 'redux/loadingSlice'
...
function GameCores() {
   ...
   useEffect(() => {
      if (!ignore) {
         ...
         store.dispatch(saveGameCoresList([]))
         setTimeout(() => {
            setIgnore(true)
         }, 500)
      }
